...
const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    copy: "My role focuses on bringing brand story to life across different formats. Day-to-day, I partner with video editors and creative directors to pitch ideas and write scripts for advertising videos. I also manage written content, which means I write and edit blogs, articles, and web copy to make sure messaging stays consistent, engaging, and aligned with the brand goals.",
  ...
  },
  {
    count: "02",
    role: "EDUCATION",
    company: "Master of Arts in English Language and Literature",
    start: "June 2022",
    end: "2024",
    copy: "The Cochin College, Cochin",
    cardStyle: "rotate-[-1.2deg] translate-x-1 lg:translate-x-4 bg-[var(--bg-paper-strong)] border-[rgba(107,88,65,0.12)]",
    tapeLayout: "double",
  },
  {
